...
2. Discuss the difference in memory usage based on your implementation. You will need to think about how the versions 
 store data.
   ...
   > It truly depends on how big of a file your are running. After a certain point, a linklist takes less data memory. 

3. Which version would you use in practice. Why?

   > I would practice in DSStackList because it's easier to insert and delete elements of a list than it is to do with vectors. I also understand lists more than I understand vectors. 
